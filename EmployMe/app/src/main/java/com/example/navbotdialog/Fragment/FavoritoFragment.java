...
public class FavoritoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = rootView.findViewById(R.id.recycleViewFavoritos);
        ...
        SwipeRefreshLayout swipeRefreshLayout = rootView.findViewById(R.id.swipeRefreshLayout_favorite);

        ///------------------
        // Obtén una referencia al ScrollView
        ScrollView scrollView = rootView.findViewById(R.id.scroolView_favorito);
    ...
    private void makeGetRequest(int userId) {
        ...
        String url = APIUtils.getFullUrl("favorito/" + userId);
