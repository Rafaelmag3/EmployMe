...
public class Mostrar_Post_Activity extends AppCompatActivity {
    private TextView puestoTrabajoEditText;
    private TextView noVacantesEditText;
    private TextView locacionEditText;
    private TextView diaPublicacionEditText;
    private TextView diaLimiteEditText;
    private TextView horarioEditText;
    private TextView horario2EditText;
    private TextView salarioEditText;
    private TextView funcionesEditText;
    private TextView requisitosEditText;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_post_mostrar);

        // Inicializar los atributos (EditText, Button, etc.) con findViewById
        puestoTrabajoEditText = findViewById(R.id.m_editText_puestoTrabajo);
        noVacantesEditText = findViewById(R.id.m_editText_noVacantes);
        locacionEditText = findViewById(R.id.m_editText_locacion);
        diaPublicacionEditText = findViewById(R.id.m_editText_diaPublicacion);
        diaLimiteEditText = findViewById(R.id.m_editText_diaLimite);
        horarioEditText = findViewById(R.id.m_editText_horario);
        horario2EditText = findViewById(R.id.m_editText_horario2);
        salarioEditText = findViewById(R.id.m_editText_salario);
        funcionesEditText = findViewById(R.id.m_editText_funciones);
        requisitosEditText = findViewById(R.id.m_editText_requisitos);


        // Configurar la Toolbar
        Toolbar toolbar = findViewById(R.id.toolbar_apm);
